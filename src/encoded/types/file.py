...
class CalcPropConstants:
    ...
    SAMPLE_SUMMARY_PRESERVATION_TYPES = "preservation_types"
    ...
    SAMPLE_SUMMARY_SCHEMA = {
        ...
        "properties": {
            ...
            SAMPLE_SUMMARY_PRESERVATION_TYPES: {
...
class File(Item, CoreFile):
    ...
    def _get_sample_summary_fields(
        ...
        to_include = {
            ...
            constants.SAMPLE_SUMMARY_PRESERVATION_TYPES: file_utils.get_preservation_type(file_properties, request_handler),
