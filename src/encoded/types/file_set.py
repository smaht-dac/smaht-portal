...
def _build_file_set_embedded_list():
    ...
    return [
        ...
        "libraries.analytes.molecule",
        "libraries.analytes.molecule_detail",
        "libraries.analytes.a260_a280_ratio",
        "libraries.analytes.average_fragment_size",
        "libraries.analytes.concentration",
        "libraries.analytes.concentration_unit",
        "libraries.analytes.description",
        "libraries.analytes.dna_integrity_number",
        "libraries.analytes.dna_integrity_number_instrument",
        "libraries.analytes.dna_quality_number",
        "libraries.analytes.dna_quality_number_instrument",
        "libraries.analytes.dna_quality_size_threshold",
        "libraries.analytes.external_id",
        "libraries.analytes.genomic_quality_number",
        "libraries.analytes.genomic_quality_number_instrument",
        "libraries.analytes.genomic_quality_size_threshold",
        "libraries.analytes.quantitation_method",
        "libraries.analytes.ribosomal_rna_ratio",
        "libraries.analytes.rna_integrity_number",
        "libraries.analytes.rna_integrity_number_instrument",
        "libraries.analytes.sample_quantity",
        "libraries.analytes.sample_quantity_unit",
        "libraries.analytes.total_yield",
        "libraries.analytes.volume",
        "libraries.analytes.volume_unit",
        "libraries.analytes.yield_per_unit",
        "libraries.analytes.yield_unit",
        "libraries.analytes.analyte_preparation.cell_lysis_method",
        "libraries.analytes.analyte_preparation.description",
        "libraries.analytes.analyte_preparation.extraction_method",
        "libraries.analytes.analyte_preparation.homogenization_method",
        "libraries.analytes.analyte_preparation.suspension_type",
        "libraries.analytes.analyte_preparation.treatments.agent",
        "libraries.analytes.analyte_preparation.treatments.concentration",
        "libraries.analytes.analyte_preparation.treatments.concentration_units",
        "libraries.analytes.analyte_preparation.treatments.duration",
        "libraries.analytes.analyte_preparation.treatment.temperature",
        "libraries.analytes.analyte_preparation.preparation_kits.title",
        "libraries.analytes.analyte_preparation.preparation_kits.catalog_number",
        "libraries.analytes.analyte_preparation.preparation_kits.vendor",
        "libraries.analytes.analyte_preparation.preparation_kits.version",
