...
@pytest.mark.parametrize(
    "patch_body,expected_status", [
        ...
        ({"donor": "TEST_DONOR_MALE", "external_id": "ST001-1D", "uberon_id": "UBERON:0008952", "preservation_type": "FOO",}, 422),
        ({"donor": "TEST_DONOR_MALE", "external_id": "ST001-1D", "uberon_id": "UBERON:0008952", "preservation_type": "Fixed"}, 200),
    ]
)
...
@pytest.mark.parametrize(
    "patch_body,expected_status,index", [
        ...
        ({"donor": "TEST_DONOR_MALE", "external_id": "ST001-1D", "uberon_id": "UBERON:0008952", "preservation_type": "FOO",}, 422, 6),
        ({"donor": "TEST_DONOR_MALE", "external_id": "ST001-1D", "uberon_id": "UBERON:0008952", "preservation_type": "Fixed"}, 201, 7),
    ]
)
