...
function UserActionsMenu(props) {
    ...
    const renderedActions = userActions.map(function (action, idx) {
        ...
        if (actionID === 'impersonate') {
            prepend = <i className="icon icon-fw icon-user-secret fas me-1" />;
        }
        if (actionID === 'profile') {
            prepend = <i className="icon icon-fw icon-user fas me-1" />;
        }
        if (actionID === 'submissions') {
            prepend = <i className="icon icon-fw icon-file-import fas me-1" />;
        }
        return (
            <div
                className={
