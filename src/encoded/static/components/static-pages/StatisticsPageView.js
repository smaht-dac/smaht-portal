...
export default class StatisticsPageView extends React.PureComponent {
    ...
    renderSubmissionsSection(){
        ...
        const groupByOptions = {
                ...
                'data_generation_summary.assays'                : <span><i className="icon icon-fw fas icon-vial mr-1"/>Experimental Assay</span>,
                'file_format.display_title'                     : <span><i className="icon icon-fw fas icon-file-alt mr-1"/>File Format</span>,
                // 'data_generation_summary.sequencing_center'     : <span><i className="icon icon-fw fas icon-dna mr-1"/>Generated By</span>,
    ...
    renderUsageSection(){
        ...
        return (
            <dynamicImports.GroupByController groupByOptions={groupByOptions} initialGroupBy="daily30">
