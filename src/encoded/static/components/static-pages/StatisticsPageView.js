            ...
            <div className="chart-section-control-wrapper row">
                <div className="col-sm-6">
                    <a className={"select-section-btn" + (currentTab === 'submissions' ? ' active' : '')}
                        ...
                        { submissionsObj.icon ? <i className={"me-1 text-medium icon icon-fw icon-" + submissionsObj.icon}/> : null }
                ...
                <div className="col-sm-6">
                    <a className={"select-section-btn" + (currentTab === 'usage' ? ' active' : '')}
                        ...
                        { usageObj.icon ? <i className={"me-1 text-medium icon icon-fw icon-" + usageObj.icon}/> : null }
                        { usageObj.title }
                    </a>
                </div>
            </div>
