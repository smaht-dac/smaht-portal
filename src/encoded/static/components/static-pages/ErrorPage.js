            ...
            errorMessage = (
                <div>
                    <h3>
                        ...
                        <a href="/" className="link-offset-2 link-underline link-underline-opacity-0 link-underline-opacity-100-hover">Return</a> to the homepage.
                    </h3>
                    <h5>
                    ...
                    <h5>
                        <a href="mailto:4DN.DCIC.support@hms-dbmi.atlassian.net" className="link-offset-2 link-underline link-underline-opacity-0 link-underline-opacity-100-hover">
                            Request an account.
                        </a>
                    </h5>
                </div>
    ...
    return (
        <ErrorContainer>
            ...
            <p className="mb-0 mt-0">
                ...
                <a href="/" className="link-offset-2 link-underline link-underline-opacity-0 link-underline-opacity-100-hover">homepage</a>.
                <br />
                For instructions on how to set up an account, please visit the
                help page for{' '}
                <a href="/help/account-creation" className="link-offset-2 link-underline link-underline-opacity-0 link-underline-opacity-100-hover">Creating an Account</a>.
            </p>
        </ErrorContainer>
    );
});
