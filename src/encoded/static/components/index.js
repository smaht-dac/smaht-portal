...
import PathologyReportView from './item-pages/PathologyReportView';
...
content_views.register(PathologyReportView, 'BrainPathologyReport');
content_views.register(PathologyReportView, 'NonBrainPathologyReport');
