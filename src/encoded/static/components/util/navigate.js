...
// TODO: further investigate these functions to remove 4DN dependencies, for now
// what is removed should be considered a "light check"
 ...
 *
 * @param {string} [browseBaseState='all'] The browse base state. By default is set to "only_4dn" on app init.
 * @returns {Object} JSON form of URI query params for given or current browseBaseState.
 */
navigate.getBrowseBaseParams = function(browseBaseState = 'all'){
