...
import { donorSelfReportedEthnicityData, renderEthnicityPopover } from './BrowseDonor';
            ...
            <div className="row browse-viz-container">
                <div className="stats-column col-auto">
                    ...
                    <BrowseSummaryStatsViewer
                        {...{ session, href, windowWidth, useCompactFor, mapping: 'protected-donor' }}
                    />
                    <IconToggle
                        options={[
                            {
