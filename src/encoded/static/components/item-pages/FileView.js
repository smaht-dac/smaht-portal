...
const FileViewDataCards = ({ context }) => {
    const file_properties = [
        ...
        {
            title: 'Size',
            getProp: (context) => context.file_size,
        },
        {
            title: 'MD5 Checksum',
            getProp: (context) => context.extra_files[0].md5sum,
        },
        {
            title: 'Project',
            getProp: (context) => context.file_summary.consortia.join(', '),
        },
        {
    ...
    const sample_information = [
        ...
        {
            title: 'Analyte',
            getProp: (context) => context.sample_summary.analytes.join(', '),
        },
    ];
