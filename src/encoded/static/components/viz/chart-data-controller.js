...
export const ChartDataController = {
    ...
    initialize : function(browseBaseState = null, fields = null, callback = null){
        ...
        reduxSubscription = refs.store.subscribe(function(){
            ...
            const prevBrowseBaseParams = navigate.getBrowseBaseParams('all');
            const nextBrowseBaseParams = navigate.getBrowseBaseParams('all');
    ...
    fetchUnfilteredAndFilteredBarPlotData : function(callback = null, opts = {}){
        const currentBrowseBaseParams = navigate.getBrowseBaseParams('all');
        ...
        const baseSearchParams = navigate.getBrowseBaseParams('all');
    ...
    fetchAndSetFilteredBarPlotData : function(callback = null, opts = {}){
        ...
        const filteredSearchParams = navigate.mergeObjectsOfLists(
            { 'q' : searchQuery || null },
            navigate.getBrowseBaseParams('all'),
            searchFilters.expSetFiltersToJSON(currentExpSetFilters)
        );
