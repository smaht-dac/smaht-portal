...
class ReadLengthCategoryEnum(Enum):
    Long_read = 'Long-read'
...
class Sequencer(BaseModel):
    ...
    code: constr(pattern=r'^[A-Z]{1}$') = Field(
    ...
    platform: str = Field(
        ..., description='Name of the platform used to obtain data', title='Platform'
    )
    read_length_category: Optional[List[ReadLengthCategoryEnum]] = Field(
        None,
