...
class PrimarySourceOfInformation(Enum):
    TBD = 'TBD'
...
class MedicalHistory(BaseModel):
    ...
    submitted_id: constr(pattern=r'^[A-Z0-9]{3,}_MEDICAL-HISTORY_[A-Z0-9-_.]{4,}$') = (
    ...
    primary_source_of_information: Optional[PrimarySourceOfInformation] = Field(
        None,
