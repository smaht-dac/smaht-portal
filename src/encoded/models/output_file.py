...
class ExtraFile(BaseModel):
    ...
    href: Optional[str] = Field(None, title='Download URL')
    md5sum: Optional[str] = Field(None, title='MD5sum')
    status: Optional[Status1] = Field('uploading', title='Status')
...
class OutputFile(BaseModel):
    ...
    extra_files: Optional[List[ExtraFile]] = Field(
        None,
