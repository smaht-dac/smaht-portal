...
class Exposure(BaseModel):
    ...
    submitted_id: constr(pattern=r'^[A-Z0-9]{3,}_EXPOSURE_[A-Z0-9-_.]{4,}$') = Field(
    ...
    age_at_exposure_end: Optional[confloat(ge=0.0)] = Field(
        None,
        description='Age when the exposure resolved in years',
        title='Age At Exposure End',
    )
    age_at_exposure_start: Optional[confloat(ge=0.0)] = Field(
        None,
        description='Age when the exposure began in years',
        title='Age At Exposure Start',
    )
    comments: Optional[str] = Field(
        None, description='Additional information on the exposure', title='Comments'
    )
