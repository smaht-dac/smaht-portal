...
class User(BaseModel):
    ...
    first_name: str = Field(
        ..., description="The user's first (given) name", title='First name'
    )
    email: EmailStr = Field(
        ..., description='Email used to log in to the portal', title='Account Email'
    )
    groups: Optional[List[Group]] = Field(
        None, description='Additional access control groups', title='Groups'
    )
    last_name: str = Field(
        ..., description="The user's last (family) name", title='Last name'
    )
    preferred_email: Optional[EmailStr] = Field(
        None,
        description='Email to contact by, if different from account/sign-in e-mail address',
    ...
    submits_for: Optional[List[str]] = Field(
        None,
    ...
    contact_email: Optional[EmailStr] = Field(None, title='Contact Email')
