...
#   filename:  higlass_view_config.json
...
class HiglassViewConfiguration(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    ...
    view_config: Dict[str, Any] = Field(
        ..., description='The viewconfig JSON', title='View Configuration'
    )
    instance_height: Optional[int] = Field(500, title='Instance Height')
