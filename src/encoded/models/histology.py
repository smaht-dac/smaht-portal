...
class Histology(BaseModel):
    ...
    submitted_id: constr(pattern=r'^[A-Z0-9]{3,}_HISTOLOGY_[A-Z0-9-_.]{4,}$') = Field(
    ...
    section_location: Optional[SectionLocation] = Field(
        None,
        description='Location in the source material that was prepared for the slide',
        title='Section Location',
    )
    images: Optional[List[str]] = Field(
        None, description='Histology images', min_length=1, title='Images'
    )
    tissue: str = Field(..., description='Tissue source for the sample', title='Tissue')
