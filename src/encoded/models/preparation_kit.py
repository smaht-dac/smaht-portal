...
class PreparationKit(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    ...
    submitted_id: constr(pattern=r'^[A-Z0-9]{3,}_PREPARATION-KIT_[A-Z0-9-_.]{4,}$') = (
    ...
    catalog_number: Optional[str] = Field(
        None, description='Catalog number of preparation kit', title='Catalog Number'
    )
    vendor: str = Field(..., description='Vendor of preparation kit', title='Vendor')
