...
class AlignedReads(BaseModel):
    ...
    submitted_id: constr(pattern=r'^[A-Z0-9]{3,}_ALIGNED-READS_[A-Z0-9-_.]{4,}$') = (
    ...
    data_type: Optional[List[DataTypeEnum]] = Field(
        ['Aligned Reads'], min_length=1, title='Data Type'
    )
    ...
    reference_genome: str = Field(
        ..., description='Reference genome used for alignment', title='Reference Genome'
    )
