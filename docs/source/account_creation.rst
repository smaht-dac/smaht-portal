...
Once your institutional account is connected to google, click Sign in with Google and choose your institutional email. Now you will see your email in the self registration process. Choose “No, I am not a member of the SMaHT Network” to proceed to the rest of the self-registration steps.
...
.. NOTE::
    SMaHT Network members have **early access** to the data generated by the SMaHT Network. Before creating the SMaHT Data Portal account, a Network member must be verified by the SMaHT Organization Center (OC) at Washington University at St. Louis. **Do not go through the self-registration steps described above**.
...
.. image:: /static/img/docs/account_creation/member_checked_modal.png
   :alt: SMaHT Data Portal Login Modal with Member Checked
...
.. image:: /static/img/docs/account_creation/member_checked_self_registration.png
   :alt: SMaHT Data Portal User Registration Form with Member Checked
